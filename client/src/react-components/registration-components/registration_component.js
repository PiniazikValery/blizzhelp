    ...
    return (
      <div id="registrationMenu">
        <form>
          ...
          <ul id="menuFields">
            <li>
              <input className="longField" placeholder="Email" id="registrationEmail" value={this.state.email} onChange={this.handleEmailTyping} />
            </li>
            <li>
              <input className="longField" placeholder="Username" id="registrationUsername" value={this.state.username} onChange={this.handleUsernameTyping} />
            </li>
            <li>
              <input className="longField" type="password" placeholder="Password" id="registrationPassword" value={this.state.password} onChange={this.handlePasswordTyping} />
            </li>
            <li>
              <input className="longField" type="password" placeholder="Re-enter password" id="registrationRewritedPassword" value={this.state.rewrited_password} onChange={this.handlePasswordRewriting} />
            </li>
            <li>
              <button id="GenerateCodeButton" type="button" onClick={this.onClickGenerateCode}>Send code</button>
              <input className="shortField" placeholder="Code" id="registrationAuthCode" value={this.state.auth_code} onChange={this.handleAuthCodeTyping} />
            </li>
          </ul>
